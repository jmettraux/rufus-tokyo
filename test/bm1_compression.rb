...
puts 'no compression  : ' + `ls -lh toto0.tdb | awk '{ print $5 }'`
puts 'deflate         : ' + `ls -lh toto1.tdb | awk '{ print $5 }'`
puts 'bzip2           : ' + `ls -lh toto2.tdb | awk '{ print $5 }'`
puts 'tcbs            : ' + `ls -lh toto3.tdb | awk '{ print $5 }'`
